...
Esse projeto foi desenvolvido para a entrega individual da Fase 1 do Tech Challenge[cite: 1]. O objetivo principal é analisar os dados de um e-commerce para entender o que faz a nota de satisfação do cliente (NPS) subir ou cair, e como a operação da empresa pode melhorar antes de o cliente ficar insatisfeito[cite: 1].

---

## Estrutura do Repositório

* **data/**: pasta onde está o arquivo com os dados dos pedidos (desafio_nps_fase_1.csv)[cite: 1].
* **notebooks/**: pasta onde está o arquivo de código em Python (EDA_NPS.ipynb).
* **README.md**: este arquivo com o resumo e as explicações do trabalho[cite: 1].

---

## 1. Entendimento do Negócio

* **Problema que estamos resolvendo:** Hoje a empresa só descobre que o cliente teve uma experiência ruim no final de tudo, quando envia a pesquisa[cite: 1]. A ideia aqui é olhar os dados do processo (como tempo de entrega e contatos no suporte) para entender a causa das notas baixas e agir antes[cite: 1].
...
* **Variável escolhida:** `nps_score` (que foi dividida em Detrator, Neutro e Promotor)[cite: 1].
* **Por que escolhi:** É a variável que traz diretamente a nota que o cliente deu para a experiência dele[cite: 1].
* **Quando é coletada:** No fim da jornada, depois que o produto já foi entregue e o atendimento finalizado[cite: 1].
...
Ao analisar a base de dados no Python, cheguei às seguintes conclusões[cite: 1]:
...
3. **Situação da base:** A maioria da base (74%) é composta por detratores[cite: 1], o que mostra que a operação precisa ajustar urgente o cumprimento dos prazos e o suporte.
